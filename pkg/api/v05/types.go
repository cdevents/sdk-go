...
func NewCDEvent(eventType, specVersion string) (api.CDEvent, error) {
	switch eventType {
	case api.ArtifactDeletedEventTypeV0_2_0.String():
		return NewArtifactDeletedEvent()
	case api.ArtifactDownloadedEventTypeV0_2_0.String():
		return NewArtifactDownloadedEvent()
	case api.ArtifactPackagedEventTypeV0_3_0.String():
		return NewArtifactPackagedEvent()
	case api.ArtifactPublishedEventTypeV0_3_0.String():
		return NewArtifactPublishedEvent()
	case api.ArtifactSignedEventTypeV0_3_0.String():
		return NewArtifactSignedEvent()
	case api.BranchCreatedEventTypeV0_3_0.String():
		return NewBranchCreatedEvent()
	case api.BranchDeletedEventTypeV0_3_0.String():
		return NewBranchDeletedEvent()
	case api.BuildFinishedEventTypeV0_3_0.String():
		return NewBuildFinishedEvent()
	case api.BuildQueuedEventTypeV0_3_0.String():
		return NewBuildQueuedEvent()
	case api.BuildStartedEventTypeV0_3_0.String():
		return NewBuildStartedEvent()
	case api.ChangeAbandonedEventTypeV0_3_0.String():
		return NewChangeAbandonedEvent()
	case api.ChangeCreatedEventTypeV0_4_0.String():
		return NewChangeCreatedEvent()
	case api.ChangeMergedEventTypeV0_3_0.String():
		return NewChangeMergedEvent()
	case api.ChangeReviewedEventTypeV0_3_0.String():
		return NewChangeReviewedEvent()
	case api.ChangeUpdatedEventTypeV0_3_0.String():
		return NewChangeUpdatedEvent()
	case api.EnvironmentCreatedEventTypeV0_3_0.String():
		return NewEnvironmentCreatedEvent()
	case api.EnvironmentDeletedEventTypeV0_3_0.String():
		return NewEnvironmentDeletedEvent()
	case api.EnvironmentModifiedEventTypeV0_3_0.String():
		return NewEnvironmentModifiedEvent()
	case api.IncidentDetectedEventTypeV0_3_0.String():
		return NewIncidentDetectedEvent()
	case api.IncidentReportedEventTypeV0_3_0.String():
		return NewIncidentReportedEvent()
	case api.IncidentResolvedEventTypeV0_3_0.String():
		return NewIncidentResolvedEvent()
	case api.PipelineRunFinishedEventTypeV0_3_0.String():
		return NewPipelineRunFinishedEvent()
	case api.PipelineRunQueuedEventTypeV0_3_0.String():
		return NewPipelineRunQueuedEvent()
	case api.PipelineRunStartedEventTypeV0_3_0.String():
		return NewPipelineRunStartedEvent()
	case api.RepositoryCreatedEventTypeV0_3_0.String():
		return NewRepositoryCreatedEvent()
	case api.RepositoryDeletedEventTypeV0_3_0.String():
		return NewRepositoryDeletedEvent()
	case api.RepositoryModifiedEventTypeV0_3_0.String():
		return NewRepositoryModifiedEvent()
	case api.ServiceDeployedEventTypeV0_3_0.String():
		return NewServiceDeployedEvent()
	case api.ServicePublishedEventTypeV0_3_0.String():
		return NewServicePublishedEvent()
	case api.ServiceRemovedEventTypeV0_3_0.String():
		return NewServiceRemovedEvent()
	case api.ServiceRolledbackEventTypeV0_3_0.String():
		return NewServiceRolledbackEvent()
	case api.ServiceUpgradedEventTypeV0_3_0.String():
		return NewServiceUpgradedEvent()
	case api.TaskRunFinishedEventTypeV0_3_0.String():
		return NewTaskRunFinishedEvent()
	case api.TaskRunStartedEventTypeV0_3_0.String():
		return NewTaskRunStartedEvent()
	case api.TestCaseRunFinishedEventTypeV0_3_0.String():
		return NewTestCaseRunFinishedEvent()
	case api.TestCaseRunQueuedEventTypeV0_3_0.String():
		return NewTestCaseRunQueuedEvent()
	case api.TestCaseRunSkippedEventTypeV0_2_0.String():
		return NewTestCaseRunSkippedEvent()
	case api.TestCaseRunStartedEventTypeV0_3_0.String():
		return NewTestCaseRunStartedEvent()
	case api.TestOutputPublishedEventTypeV0_3_0.String():
		return NewTestOutputPublishedEvent()
	case api.TestSuiteRunFinishedEventTypeV0_3_0.String():
		return NewTestSuiteRunFinishedEvent()
	case api.TestSuiteRunQueuedEventTypeV0_3_0.String():
		return NewTestSuiteRunQueuedEvent()
	case api.TestSuiteRunStartedEventTypeV0_3_0.String():
		return NewTestSuiteRunStartedEvent()
	case api.TicketClosedEventTypeV0_2_0.String():
		return NewTicketClosedEvent()
	case api.TicketCreatedEventTypeV0_2_0.String():
